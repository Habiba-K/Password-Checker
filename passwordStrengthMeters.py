""" # Project 02: Password Strength Meter  Project 3 
# Objective : uild a Password Strength Meter in Python that evaluates a user's password based on security rules. The program will:
...
st.set_page_config(page_title = "Paaword Strength Checker By Habiba Khan", page_icon="🌘", layout = "centered")
...
<style>
    ...
    .stButton button {align:center;  width: 50%; background-color: blue; color: white; font-size:18px ;}
    .stButton button:hover {background-color: #1e81b0 ; color:white;}
</style>
